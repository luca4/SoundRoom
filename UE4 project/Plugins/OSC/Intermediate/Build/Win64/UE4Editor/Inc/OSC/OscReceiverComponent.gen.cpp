...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOscReceiverComponent_Statics::NewProp_OnOscReceived = { "OnOscReceived", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::MulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOscReceiverComponent, OnOscReceived), Z_Construct_UDelegateFunction_OSC_ComponentOscReceivedSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UOscReceiverComponent_Statics::NewProp_OnOscReceived_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOscReceiverComponent_Statics::NewProp_OnOscReceived_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UOscReceiverComponent, 928462561);
